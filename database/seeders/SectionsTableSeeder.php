...
class SectionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Section::updateOrCreate(['id' => 405], ['name' => 'admin_quiz_result_review', 'section_group_id' => 400, 'caption' => 'Review Result']);
        Section::updateOrCreate(['id' => 406], ['name' => 'admin_quiz_result_export_excel', 'section_group_id' => 400, 'caption' => 'quiz result export excel']);
        ...
        Section::updateOrCreate(['id' => 656], ['name' => 'admin_settings_update_app', 'section_group_id' => 650, 'caption' => 'Update App settings']);
        Section::updateOrCreate(['id' => 657], ['name' => 'admin_settings_mobile_app', 'section_group_id' => 650, 'caption' => 'Mobile App settings']);
        ...
        Section::updateOrCreate(['id' => 1501], ['name' => 'admin_additional_pages_errors', 'section_group_id' => 1500, 'caption' => 'Errors page settings (404, 419, 403, 500)']);
        ...
        // featured categories
        Section::updateOrCreate(['id' => 1837], ['name' => 'admin_store_featured_categories', 'section_group_id' => 1800, 'caption' => 'Store Featured Categories (List/Create/Delete)']);
        ...
        // Admin Front Theme 3150 - 3169
        Section::updateOrCreate(['id' => 3150], ['name' => 'admin_themes', 'caption' => 'Themes And Theme Settings']);
        Section::updateOrCreate(['id' => 3151], ['name' => 'admin_themes_create', 'section_group_id' => 3150, 'caption' => 'Create/Edit']);
        Section::updateOrCreate(['id' => 3152], ['name' => 'admin_themes_delete', 'section_group_id' => 3150, 'caption' => 'Delete']);
        Section::updateOrCreate(['id' => 3153], ['name' => 'admin_themes_colors', 'section_group_id' => 3150, 'caption' => 'Colors (Create/Edit/Delete)']);
        Section::updateOrCreate(['id' => 3154], ['name' => 'admin_themes_fonts', 'section_group_id' => 3150, 'caption' => 'Fonts (Create/Edit/Delete)']);
        Section::updateOrCreate(['id' => 3155], ['name' => 'admin_themes_headers', 'section_group_id' => 3150, 'caption' => 'Headers (Edit)']);
        Section::updateOrCreate(['id' => 3156], ['name' => 'admin_themes_footers', 'section_group_id' => 3150, 'caption' => 'Footers (Edit)']);


        // Landing Builder 3170 - 3189
        Section::updateOrCreate(['id' => 3170], ['name' => 'admin_landing_builder', 'caption' => 'Landing Builder']);
        Section::updateOrCreate(['id' => 3171], ['name' => 'admin_landing_builder_create', 'section_group_id' => 3170, 'caption' => 'Create/Edit']);
        Section::updateOrCreate(['id' => 3172], ['name' => 'admin_landing_builder_preview', 'section_group_id' => 3170, 'caption' => 'Preview']);
        Section::updateOrCreate(['id' => 3173], ['name' => 'admin_landing_builder_duplicate', 'section_group_id' => 3170, 'caption' => 'Duplicate']);
        Section::updateOrCreate(['id' => 3174], ['name' => 'admin_landing_builder_delete', 'section_group_id' => 3170, 'caption' => 'Delete']);
