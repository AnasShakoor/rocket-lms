...
@section('formContent')
    <div class="card-with-mask position-relative">
        ...
        <div class="position-relative d-flex-center flex-column text-center mt-28 bg-white rounded-32 p-32 z-index-2">
            <div class="">
                <img src="/assets/design_1/img/forms/expired.png" alt="{{ trans('update.access_denied') }}" class="img-fluid" height="300px">
            </div>

            <h3 class="font-16 mt-16">{{ trans('update.form_expired') }}</h3>

            <div class="mt-4 font-14 text-gray-500">{{ trans("update.this_form_expired_on_date",['date' => dateTimeFormat($form->end_date, 'j M Y')]) }}</div>
