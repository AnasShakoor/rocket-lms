<div class="d-flex-center flex-column text-center mt-22">
    ...
    <div class="d-flex-center flex-wrap gap-16 mt-14">
        ...
        <a href="{{ $upcomingCourse->getShareLink('whatsapp') }}" target="_blank" class="d-flex-center size-48 rounded-12 bg-whatsapp-50">
            <x-whatsapp-bol-icon class="icons text-whatsapp" width="24px" height="24px"/>
        </a>

        <a href="{{ $upcomingCourse->getShareLink('twitter') }}" target="_blank" class="d-flex-center size-48 rounded-12 bg-twitter-50">
            <x-twitter-bol-icon class="icons text-twitter" width="24px" height="24px"/>
        </a>

        <a href="{{ $upcomingCourse->getShareLink('telegram') }}" target="_blank" class="d-flex-center size-48 rounded-12 bg-telegram-50">
            <x-telegram-bol-icon class="icons text-telegram" width="24px" height="24px"/>
        </a>

        <a href="{{ $upcomingCourse->getShareLink('facebook') }}" target="_blank" class="d-flex-center size-48 rounded-12 bg-facebook-50">
            <x-facebook-bol-icon class="icons text-facebook" width="24px" height="24px"/>
        </a>

        <a href="{{ $upcomingCourse->getShareLink('linkedin') }}" target="_blank" class="d-flex-center size-48 rounded-12 bg-linkedin-50">
            <x-linkedin-bol-icon class="icons text-linkedin" width="24px" height="24px"/>
        </a>
    </div>

    @php
        $url = $upcomingCourse->getUrl();
    @endphp
