        ...
        <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mt-8">
                            ...
                            @if(!empty($selectSupport->department))
                                <div class="d-flex align-items-center ml-32">
                                    <x-iconsax-bul-message class="icons text-gray-500" width="16px" height="16px"/>
                                    <span class="font-12 text-gray-500 ml-4">{{ $selectSupport->department->title }}</span>
                                </div>
                            @endif
                        </div>
                    </div>
            ...
            <form action="/panel/support/{{ $selectSupport->id }}/conversations" method="post" class="mt-auto" enctype="multipart/form-data">
                ...
                <div class="d-flex align-items-center pt-28 border-top-gray-100">
                    ...
                    <input type="hidden" name="attach" id="attach" value="{{ old('attach') }}" class="form-control"/>
                ...
                <div class="bg-white p-16 rounded-16 border-gray-200">
                    <div class="d-flex align-items-start justify-content-between">
                        ...
                        <div class="size-48 d-flex-center bg-success-30 rounded-12">
                            <x-iconsax-bul-message class="icons text-success" width="24px" height="24px"/>
                        </div>
                    </div>
