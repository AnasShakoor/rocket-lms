...
@can('admin_payouts')
    <li class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/financial/payouts*', false)) ? 'active' : '' }}">
        <a href="#" class="nav-link has-dropdown"><x-iconsax-bul-empty-wallet-change class="icons" width="24px"
                height="24px" /> <span>{{ trans('admin/main.payout') }}</span></a>
        <ul class="dropdown-menu">
...
@can('admin_offline_payments_list')
    <li
        ...
        <a href="#" class="nav-link has-dropdown"><x-iconsax-bul-moneys class="icons" width="24px"
                height="24px" /> <span>{{ trans('admin/main.offline_payments') }}</span></a>
        <ul class="dropdown-menu">
            <li
