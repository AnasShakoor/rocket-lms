    ...
    <div class="admin-auth-pages">
        ...
        <div class="admin-auth-pages__footer d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between bg-white px-24 py-14">
            <div class="d-flex align-items-center">
                ...
                <div class="ml-8">
                    <h5 class="font-14">MULHIM</h5>
                    <a href="https://codecanyon.net/user/rocketsoft/portfolio" class="font-12 text-gray-500 mt-4">All rights reserved for MULHIM on Codecanyon</a>
                </div>
            </div>
