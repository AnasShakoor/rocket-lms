...
@section('title', 'Edit BNPL Provider')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit BNPL Provider: {{ $provider->name }}</h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('admin.bnpl-providers.update', $provider) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="logo_path" id="logo_path"
                                           ...
                                           accept="image/*">
                                    <small class="form-text text-muted">Accepted formats: JPEG, PNG, JPG, GIF (max 2MB). Leave empty to keep current logo.</small>
                                    @error('logo_path')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="fee_percentage" id="fee_percentage"
                                               ...
                                               value="{{ old('fee_percentage', $provider->fee_percentage) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="installment_count" id="installment_count"
                                           ...
                                           value="{{ old('installment_count', $provider->installment_count) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="is_active" id="is_active" class="form-control @error('is_active') is-invalid @enderror" required>
                                        <option value="1" {{ old('is_active', $provider->is_active) == 1 ? 'selected' : '' }}>Active</option>
                                        <option value="0" {{ old('is_active', $provider->is_active) == 0 ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                    @error('is_active')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="surcharge_percentage" id="surcharge_percentage"
                                               ...
                                               value="{{ old('surcharge_percentage', $provider->surcharge_percentage ?? 8) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="bnpl_fee" id="bnpl_fee"
                                               ...
                                               value="{{ old('bnpl_fee', $provider->bnpl_fee ?? 0) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="fee_description" id="fee_description" rows="2"
                                              ...
                                              placeholder="Fee added on top of (course price + VAT)">{{ old('fee_description', $provider->fee_description) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="public_api_key" id="public_api_key"
                                           ...
                                           value="{{ old('public_api_key', $provider->public_api_key) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="secret_api_key" id="secret_api_key"
                                           ...
                                           value="{{ old('secret_api_key', $provider->secret_api_key) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="merchant_code" id="merchant_code"
                                           ...
                                           value="{{ old('merchant_code', $provider->merchant_code) }}">
                                    @error('merchant_code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="app_id" id="app_id"
                                           ...
                                           value="{{ old('app_id', $provider->app_id) }}">
                                    @error('app_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="app_secret_key" id="app_secret_key"
                                           ...
                                           value="{{ old('app_secret_key', $provider->app_secret_key) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="widget_access_key" id="widget_access_key"
                                           ...
                                           value="{{ old('widget_access_key', $provider->widget_access_key) }}">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="config" id="config" rows="4"
                                              ...
                                              placeholder='{"key": "value"}'>{{ old('config', $provider->config ? json_encode($provider->config, JSON_PRETTY_PRINT) : '') }}</textarea>
